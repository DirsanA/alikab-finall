...
import about1 from "../../assets/Coffee.png";
  ...
  return (
    <Box sx={{ width: "100%", overflowX: "hidden", mt: 2, py: 2 }}>
      <Grid container spacing={2} justifyContent="center" wrap="wrap">
        {[
          ...
          <Grid item key={index} sx={{ width: 380, display: "flex" }}>
            ...
            >
              <Box sx={{ color: "#212A5E", mr: 1 }}>{feature.icon}</Box>
      ...
      >
        ...
        >
          {[
            { value: 100, suffix: "K", label: "Tons of Sesame Exported" },
            { value: 15, suffix: "+", label: "Employment Opportunities" },
            { value: 1, suffix: "+", label: "Years of Trading Experience" },
            { value: 5, suffix: "+", label: "Export Destinations" },
